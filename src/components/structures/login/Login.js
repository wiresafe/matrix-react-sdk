...
module.exports = React.createClass({
  ...
  componentWillMount: function() {
    ...
    this._initLoginLogic(
      'https://neo.wiresafe.com',
      'https://neo-identity.wiresafe.com'
    );
  ...
  _initLoginLogic: function(hsUrl, isUrl) {
    ...
    var fallbackHsUrl =
      hsUrl == this.props.defaultHsUrl ? this.props.fallbackHsUrl : null;
  ...
  _errorTextFromError(err) {
    ...
    let errorText =
      _t('Error: Problem communicating with the given homeserver.') +
      (errCode ? ' (' + errCode + ')' : '');
        ...
        errorText = (
          <span>
            {_tJsx(
              ...
              sub => {
                return (
                  <a href="https://www.google.com/search?&q=enable%20unsafe%20scripts">
                    {sub}
                  </a>
                );
              }
  ...
  componentForStep: function(step) {
    switch (step) {
      ...
      case 'm.login.cas':
        ...
        return <CasLogin onSubmit={this.onCasLogin} />;
      default:
        if (!step) {
          return;
        }
        return (
          <div>
            {_t(
              'Sorry, this homeserver is using a login which is not recognised '
            )}({step})
          </div>
        );
    }
  ...
  _renderLanguageSetting: function() {
    const LanguageDropdown = sdk.getComponent(
      'views.elements.LanguageDropdown'
    );
    return (
      <div className="mx_Login_language_div">
        <LanguageDropdown
  ...
  render: function() {
    ...
    if (this.props.enableGuest) {
      loginAsGuestJsx = (
        <a
          className="mx_Login_create"
          onClick={this._onLoginAsGuestClick}
          href="#"
        >
          {_t('Login as guest')}
        </a>
    ...
    return (
      <div className="mx_Login">
        ...
        <div className="mx_Login_Serverconfig">
          <div className="mx_Login_ServerconfigImage">
            <img
          ...
          <div id="SettingsDiv" className="mx_Login_type_container_SettingsDiv">
            <ServerConfig
              ref="serverConfig"
